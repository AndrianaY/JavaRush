package com.javarush.level06.lesson11.bonus02;
...
//        Cat catDaughter = new Cat(daughterName, catMother);
        ...
        Cat grFatherCat = new Cat(grFatherName);

        String grdMotherName = reader.readLine();
        Cat grMotherCat = new Cat(grdMotherName);

        String fatherName = reader.readLine();
        Cat fatherCat = new Cat(fatherName, grFatherCat, null);

        String motherName = reader.readLine();
        Cat motherCat = new Cat(motherName, null, grMotherCat);
