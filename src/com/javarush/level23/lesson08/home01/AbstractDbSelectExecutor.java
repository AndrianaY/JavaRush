package com.javarush.level23.lesson08.home01;

import com.javarush.level23.lesson08.home01.vo.NamedItem;
    ...
    public List<T> execute() {
        ...
        try {
            ...
            for (int i = 1; i <= 5; i++) {
                ...
                newItem.setDescription("Got by executing '" + query + newItem.getClass().getSimpleName().toUpperCase() + "'");
                result.add(newItem);
            }
