...
//            case UP:
//            {
//                snake.sections.add(0, new SnakeSection((snake.getX()), (snake.getY()+1)));
//                snake.sections.remove(snake.sections.size()-1);
//            }
//            case DOWN:
//            {
//                snake.sections.add(0, new SnakeSection((snake.getX()), (snake.getY()-1)));
...
//            case LEFT:
//            {
//                snake.sections.add(0, new SnakeSection((snake.getX()-1), (snake.getY())));
//                snake.sections.remove(snake.sections.size()-1);
//            }
//            case RIGHT:
//            {
...
//            snake.isAlive = false;
//        }
//        for (SnakeSection ss:snake.sections)
//        {
//            if(snake.getX() == ss.getX() || snake.getY() == ss.getY()){
//                snake.isAlive = false;
//            }
//        }
//
//
//            if (snake.getX() == mouse.getX() && snake.getY() == mouse.getY()){
//                eatMouse();
//            }
//
//
