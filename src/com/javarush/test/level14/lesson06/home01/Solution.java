...
public class Solution
{
    ...
    static class HenFactory {
        ...
        static Hen getHen(String country) {
            Hen hen = null;
            switch (country){
                case("Belarus"): { hen = new BelarusianHen(); hen.country = country; return hen;}
                case ("Ukraine"): {hen = new UkrainianHen(); hen.country = country; return hen;}
                case ("Moldova"): {hen = new MoldovanHen(); hen.country = country; return hen;}
                case ("Russia"):{ hen = new RussianHen(); hen.country = country; return hen;}
                default: return hen;
            }
